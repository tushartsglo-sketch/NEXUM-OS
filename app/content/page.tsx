...
export default function ContentPage(){
 ...
 async function create(){if(!title.trim())return;const x=await fetch("/api/content",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({title,format,sourceIdea})}).then(r=>r.json());setItems(v=>[x,...v]);setTitle("");setSourceIdea("")}
